...
% Which of the two authors is Student 1 and which is Student 2 is an open
% decision for the authors (see the project plan, "Decisiones abiertas"); the
% \todo below marks where the names go once that is settled. The two profiles
...
genres); the classical classifiers of R6; experiments e04 and e05; and the
...
\todo{Both authors: state jointly-owned work explicitly, since R1--R3 (the
baseline and the shared interface contract), R10 (model comparison, e08 and
