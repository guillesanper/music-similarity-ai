...
% English is the main language of this report (in babel the last option
% wins); Spanish stays available for the cover title, the resumen and its
% keywords, which the regulations require in both languages (V.2b, V.4).
